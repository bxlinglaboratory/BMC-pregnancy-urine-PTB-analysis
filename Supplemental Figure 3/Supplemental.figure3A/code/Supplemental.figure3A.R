#######################################################################################
## Supplemental Figure 3A Early PTB model
#######################################################################################
library(ggplot2)
library(pROC)
pred_result_su <- readRDS("~data/Supplemental.figure3A.SU.data.early.PTB.rds")
pred_result_uab <- readRDS("~/data/Supplemental.figure3A.UAB.data.early.PTB.rds")
####################################
##  SU Cohort
####################################
